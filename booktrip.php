        ...
        <div class="card-img">
          <a href="booking.php"><img src="img/slanik.jpg" class="img-fluid card-img-top"></a>
            ...
            <div class="card-footer">
              <a href="files/Slanik.docx" target="_blank" class="card-link" download>Download Itinerary</a>
            </div>  
        </div>
        </div>
      </div>
      ...
      <div class="card">
        <div class="card-img">
          <a href="booking.php"><img src="img/curug.jpg" class="img-fluid card-img-top"></a>
            ...
            <div class="card-footer">
              <a href="files/Curup.docx" target="_blank" class="card-link" download>Download Itinerary</a>
            </div>  
        </div>
        </div>
      </div>
      ...
      <div class="card">
        <div class="card-img">
          <a href="booking.php"><img src="img/belerang.jpg" class="img-fluid card-img-top"></a>
            ...
            <div class="card-footer">
              <a href="files/Belerang.docx" target="_blank" class="card-link" download>Download Itinerary</a>
            </div>  
        </div>
      </div>
      </div>
      ...
      <div class="card">
        <div class="card-img">
          <a href="booking.php"><img src="img/elty.jpg" class="img-fluid card-img-top"></a>
            ...
            <div class="card-footer">
              <a href="files/Elty.docx" target="_blank" class="card-link" download>Download Itinerary
              </a>
            </div>  
        </div>
        </div>
      ...
      <div class="card">
        <div class="card-img">
          <a href="booking.php"><img src="img/kambas.jpg"  class="img-fluid card-img-top"></a>
            ...
            <div class="card-footer">
              <a href="files/WayKambas.docx" target="_blank" class="card-link" download>Download Itinerary</a>
            </div>  
        </div>
      </div>
      </div>
      ...
      <div class="card">
        <div class="card-img">
          <a href="booking.php"><img src="img/lamsel2.jpg" class="img-fluid card-img-top"></a>
            ...
            <div class="card-footer">
              <a href="files/Pahawang.docx" target="_blank" class="card-link" download>Download Itinerary</a>
            </div>  
        </div>
      </div>
      </div>
      ...
      <div class="card">
        <div class="card-img">
          <a href="booking.php"><img src="img/siger.jpg" class="img-fluid card-img-top"></a>
            ...
            <div class="card-footer">
              <a href="files/Siger.docx" target="_blank" class="card-link" download>Download Itinerary</a>
            </div>  
        </div>
      </div>
      </div>
